...
-- CreateEnum
CREATE TYPE "Flex" AS ENUM ('STIFF', 'MEDIUM', 'FLEXIBLE');

-- CreateEnum
CREATE TYPE "SkillLevel" AS ENUM ('PROFESSIONAL', 'INTERMEDIATE', 'BEGINNER');

-- CreateEnum
CREATE TYPE "PlayStyle" AS ENUM ('POWER_HEAD_HEAVY', 'SPEED_HEAD_LIGHT', 'CONTROL_EVEN_BALANCE');
...
-- CreateEnum
CREATE TYPE "ShippingMethod" AS ENUM ('STANDARD_DELIVERY', 'EXPRESS_VELOCITY');
...
-- CreateEnum
CREATE TYPE "BannerPosition" AS ENUM ('HOME_HERO', 'HOME_BANNER', 'CATEGORY_HERO');
...
CREATE TABLE "orders" (
    ...
    "shippingMethod" "ShippingMethod" NOT NULL DEFAULT 'STANDARD_DELIVERY',
    "couponId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "product_specs_productId_key" ON "product_specs"("productId");
